...
export default function AboutHimasti() {
  ...
  return (
    <>
      <div
        id="about"
        className="absolute 2xl:-mt-60 sm:-mt-24 xl:-mt-52 text-center px-10 mt-10 sm:px-20 w-full"
      >
        <div className="container text-center mx-auto">
          <h1 className=" font-bold text-md mb-5 md:text-2xl 2xl:text-4xl">
            About HIMASTI
          </h1>
          <p className="text-sm md:text-lg sm:text-md">
